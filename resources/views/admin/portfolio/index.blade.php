...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main>
                <a href="{{ route('portfolio.create') }}" style="margin: 1.25rem 0 0 1.25rem;">
                ...
                <div class="body">
                    <div id="table-container" class="table-container">
                        <table class="modern-table" id="myTable">
                            ...
                            <tbody>
                                @foreach ($portfolios as $index => $row)
                                    <tr>
                                        <td>{{ $index + 1 }}</td>
                                        <td>{{ $row->title }}</td>
                                        ...
                                        <td align="center">
                                            <a href="{{ route('portfolio.show', $row->id) }}">
                                        ...
                                        <td align="center">
                                            <form action="{{ route('portfolio.destroy', $row->id) }}"
