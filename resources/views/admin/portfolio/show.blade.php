            ...
            <main>
                <div class="table-position">
                    <div class="table-container">
                        <h1>Detail Data</h1>
                        <p><span>Title:</span> {{ $portfolio->title }}</p>
                        <p><span>Description:</span> {{ $portfolio->description }}</p>

                        <h3>Picture Detail</h3>
                        <img src="{{ asset('storage/' . $portfolio->picture) }}" alt="{{ $portfolio->title }}"
                            width="100%">
                    </div>
                </div>
                <a href="{{ route('portfolio.index') }}" class="back-btn"><button type="button"
