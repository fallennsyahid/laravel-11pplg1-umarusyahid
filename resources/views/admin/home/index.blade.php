...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <main>
                <a href="{{ route('home.create') }}" style="margin: 1.25rem 0 0 1.25rem;">
                            ...
                            <tbody>
                                @foreach ($homes as $index => $row)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($row->photos)
                                                <a href="{{ asset('storage/' . $row->photos) }}" target="_blank"><button
                                        ...
                                        <td align="center">
                                            <form action="{{ route('home.destroy', $row->id) }}"
