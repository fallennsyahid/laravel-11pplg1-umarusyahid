                ...
                @foreach ($portofolios as $portofolio)
                    <div class="mb-12 p-4 md:w-1/2">
                        ...
                        <div class="flex justify-between">
                            ...
                            <a href="{{ $portofolio->link }}" class="mt-8 mb-3" target="_blank"><span
                                    class="font-semibold text-base text-dark shadow-lg dark:text-white py-4 px-4 bg-primary rounded-md transition-all ease-in-out duration-300 hover:bg-orange-700">See
                                    More</span></a>
                        </div>
