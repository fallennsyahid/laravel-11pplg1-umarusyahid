...
<body>
    ...
    <header class="bg-transparent absolute top-0 left-0 w-full flex items-center z-10">
        <div class="container">
            <div class="flex items-center justify-between relative">
                <div class="px-4 py-6">
                    <a href="#home"
                        class="font-bold text-lg bg-gradient-to-r from-primary to-third bg-clip-text text-transparent">MyPortofolio</a>
                </div>
                <div class="flex items-center px-4">
                    ...
                    lg:static lg:bg-transparent lg:max-w-full lg:shadow-none lg:rounded-none dark:bg-dark lg:dark:bg-transparent dark:shadow-slate-500">
                        <ul class="block lg:flex" id="#nav-active">
                            <li class="group">
                                <a href="#home"
                                    class="text-sm text-dark py-2 mx-8 flex group-hover:text-primary dark:text-white">Beranda</a>
                            </li>
                            <li class="group">
                                <a href="#about"
                                    class="text-sm text-dark py-2 mx-8 flex group-hover:text-primary dark:text-white">About
                                    Me</a>
                            </li>
                            <li class="group">
                                <a href="#portfolio"
                                    class="text-sm text-dark py-2 mx-8 flex group-hover:text-primary dark:text-white">Portfolio</a>
                            </li>
                            <li class="group">
                                <a href="#skills"
                                    class="text-sm text-dark py-2 mx-8 flex group-hover:text-primary dark:text-white">Skill</a>
                            </li>
                            <li class="group">
                                <a href="#certificate"
                                    class="text-sm text-dark py-2 mx-8 flex group-hover:text-primary dark:text-white">Certificate</a>
                            </li>
                            <li class="group">
                                <a href="#contact"
                                    class="text-sm text-dark py-2 mx-8 flex group-hover:text-primary dark:text-white">Contact</a>
                            </li>
                            @if (Route::has('login'))
                                @auth
                                    <form action="{{ route('logout') }}" method="POST">
                                        ...
                                        <li class="group">
                                            <a :href="route('logout')"
                                                ...
                                                class="text-sm text-dark py-2 mx-8 flex cursor-pointer group-hover:text-primary dark:text-white">Log
                                                Out</a>
                                        </li>
                                    </form>
                                @else
                                    <li class="group">
                                        <a href="{{ route('login') }}"
                                            class="text-sm text-dark py-2 mx-8 flex group-hover:text-primary dark:text-white">
                                            Log in
                                        </a>
                                    </li>
    ...
    <!-- Hero Section Start -->
    <section id="home" class="pt-36 bg-gradient-to-r dark:bg-gradient-to-r dark:from-gray-800 dark:to-black">
        <div class="container">
                ...
                <div class="flex flex-wrap">
                    <div class="w-full self-center px-4 lg:w-1/2">
                        ...
                        <p class="font-medium text-secondary mb-10 leading-relaxed">{{ $home->description }}, <span
                                class="text-dark font-bold dark:dark:text-white">ganbatte!</span></p>
                    ...
                    <div class="w-full self-end px-4 lg:w-1/2 md:scale-110 overflow-hidden">
                        <div class="mt-10 relative lg:mt-9 lg:right-0">
                            <img src="{{ Storage::url($home->photos) }}" alt="{{ $home->title }}"
                                class="relative z-10 max-w-full mx-auto -top-6" />
                            <span class="absolute bottom-0 left-1/2 -translate-x-1/2 -top-3">
                                <svg width="400" height="400" viewBox="0 0 200 200"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill="rgb(249 115 22)" d="M35,-40.7C49.9,-37.5,69.4,-33.2,71.4,-23.9C73.4,-14.7,57.8,
            ...
            <div class="flex flex-wrap">
                ...
                <div class="w-full mx-auto flex justify-center">
                    <div class="flex items-center">
                        ...
                        <!-- Github -->
                        <a href="https://github.com/fallennsyahid" target="_blank"
                            class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-300 hover:border-primary bg-primary hover:text-white">
                            <svg role="img" width="20" height="20" viewBox="0 0 24 24"
                                class="fill-current" xmlns="http://www.w3.org/2000/svg">
                                <title>GitHub</title>
                ...
                @foreach ($portofolios as $portofolio)
                    <div class="mb-12 p-4 md:w-1/2">
                        ...
                        <div class="flex justify-between">
                            ...
                            <a href="{{ $portofolio->link }}" class="mt-5">
                                <span
                                    class="font-semibold text-base text-white shadow-lg py-2 px-4 bg-primary rounded-md transition-all ease-in-out duration-300 hover:bg-orange-700 text-center">
                                    See More
                                </span>
                            </a>
                        </div>
                        <p class="font-medium text-base text-secondary mt-2">
            ...
            <div class="w-full px-4">
                <div class="flex flex-wrap items-center justify-center">
                    @foreach ($skills as $skill)
                        <a href="{{ $skill->description }}" target="_blank"
                            class="max-w-[120px] mx-4 py-4 lg:mx-6 xl:mx-8 dark:opacity-100 ">
                            <img src="{{ Storage::url($skill->photo) }}" alt="" height="100"
                                width="100" />
                        </a>
                    @endforeach
                </div>
                            ...
                            <a href="{{ asset('storage/' . $certificate->picture) }}" target="_blank">
                                <div class="relative group">
                                    ...
                                    <div
                                        ...
                                        <p class="text-white font-bold text-lg">See More</p>
                                    </div>
                                </div>
                            </a>
                            <div class="py-8 px-6">
        ...
        <div class="container">
            <div class="flex flex-wrap">
                ...
                <div class="w-full px-4 mb-12 pl-24 md:w-1/4">
                    <h3 class="font-semibold text-xl text-white mb-5"><a href="#skill"
